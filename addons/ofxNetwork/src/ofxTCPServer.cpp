...
void ofxTCPServer::threadedFunction(){
	while( isThreadRunning() ){
		...
		if( !TCPServer.Accept(TCPConnections[acceptId].TCPClient) ){		// Blocking call to winsock accept() that waits for a new socket connection.
